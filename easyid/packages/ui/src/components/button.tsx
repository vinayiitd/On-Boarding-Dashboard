...
const buttonVariants = cva(
  ...
  ].join(" "),
  {
    variants: {
      variant: {
        default:
          "bg-[var(--primary)] text-[var(--primary-foreground)] shadow-[0_1px_2px_rgba(15,23,42,0.12)] hover:brightness-[1.05]",
        subtle:
        ...
        destructive: "bg-[var(--danger)] text-[var(--danger-foreground)] hover:brightness-[1.05]",
      },
      size: {
