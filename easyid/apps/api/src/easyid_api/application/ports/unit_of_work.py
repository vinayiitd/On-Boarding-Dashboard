...
class UnitOfWork(Protocol):
    ...
    Handlers obtain a UoW, perform repository operations through it (once
    concrete repositories exist), then `commit()` explicitly. Exiting the
    context without a commit rolls back. The application never sees the
